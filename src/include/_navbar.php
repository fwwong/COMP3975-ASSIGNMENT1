<nav class="navbar navbar-expand-lg bg-primary mb-3 p-3" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    $loggedIn = false; // Example variable, you should replace this with your actual login check logic
    if ($loggedIn) {
      // If logged in, set the home link to home.php
      $homeLink = "../home.php";
    } else {
      // If not logged in, set the home link to index.php
      $homeLink = "../index.php";
    }
    ?>

    <a class="home p-3" href="<?php echo $homeLink; ?>">
      <h2>
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="none" viewBox="0 0 40 40">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo $homeLink; ?>">Home
